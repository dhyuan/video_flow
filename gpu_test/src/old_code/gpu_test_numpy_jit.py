...
def core_cal(total_cal_numb, layer1, layer2,
    ...
    if s_id[0] == t_id[0]:
        cuda.atomic.add(d_results, i, (src_obj_probs[0] + test_obj_probs[0]))
    elif s_id[0] == t_id[1]:
        cuda.atomic.add(d_results, i, (src_obj_probs[0] + test_obj_probs[1]))
    elif s_id[1] == t_id[0]:
        cuda.atomic.add(d_results, i, (src_obj_probs[1] + test_obj_probs[0]))
    elif s_id[1] == t_id[1]:
        cuda.atomic.add(d_results, i, (src_obj_probs[1] + test_obj_probs[1]))
